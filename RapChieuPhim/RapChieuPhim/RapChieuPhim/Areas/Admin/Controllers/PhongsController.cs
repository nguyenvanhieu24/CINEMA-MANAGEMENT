...
namespace RapChieuPhim.Areas.Admin.Controllers
{
    public class PhongsController : BaseController
    {
        ...
        {
            List<Phong> phongs = db.Phongs.Include(p => p.RapPhim).ToList();
        ...
        public ActionResult Create([Bind(Include = "Id,IdRapChieu,TenPhong,SoLuong,TrinhTrang,MoTa")] Phong phong)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,IdRapChieu,TenPhong,SoLuong,TrinhTrang,MoTa")] Phong phong)
        {
            if (ModelState.IsValid)
            {
