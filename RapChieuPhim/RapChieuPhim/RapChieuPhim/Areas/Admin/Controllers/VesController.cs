...
namespace RapChieuPhim.Areas.Admin.Controllers
{
    public class VesController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,IdTaiKhoan,IdRap,NgayDat,GiaVe,Id_LichChieu,Soluong")] Ve ve)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,IdTaiKhoan,IdRap,NgayDat,GiaVe,Id_LichChieu,Soluong")] Ve ve)
        {
            if (ModelState.IsValid)
            {
